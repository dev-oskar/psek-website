      ...
      },
      {
        ...
        fields: [
          ...
          },
          {
            ...
            name: "authors",
            label: "Autorzy",
            description: "Np. 'Kowalski A, et al.'",
            required: false,
          },
          {
            type: "string",
            name: "institution",
            label: "Instytucja",
            description: "Np. 'Uniwersytet Medyczny w Warszawie'",
            required: false,
          },
          {
            type: "string",
          ...
          },
          {
            type: "string",
            name: "category",
            label: "Kategoria badań",
            options: ["Badania medyczne", "Badania agronomiczne", "Technologie przetwórstwa", "Analizy rynkowe", "Inne"],
            required: false,
          },
          {
            type: "rich-text",
